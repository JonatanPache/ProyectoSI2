...
import 'package:seguro_motors_final/src/pages/siniestros/soli_siniestro_card_detail.dart';
...
class SolicitudCard extends StatelessWidget {
  ...
  const SolicitudCard({Key? key, @required this.data, required this.con}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    print("date "+data!.date_solicitud);
    return Container(
      ...
      child: OpenContainer(
        ...
        openBuilder: (context, action) {
          return SoliSiniestroDetailScreen(data: data,con: con);
        },
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 1),
                    Text(
                      "Nro Solicitud: SIN-00"+data!.id!??'1',
                    ),
                    const Spacer(),
                    SvgPicture.asset(
                ...
                Row(
                  children: [
                    SizedBox(width: 30),
                    Text(
                      data!.cliente_id !=null?"Fecha: "+data!.date_solicitud:'A',
                    ),
                  ],
                ),
                SizedBox(height: 2),
